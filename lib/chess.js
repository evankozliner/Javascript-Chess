...
function getHasMoved(piece) {
    var pieces = getPieces();
    return pieces[piece.team][piece.type + piece.number]["hasMoved"];
}
/**
 * Setter for hasMoved
 * @param {element} piece
 */
function setHasMoved(piece) {
    var pieces = getPieces();
    console.log(pieces[piece.team][piece.type + piece.number]["hasMoved"]);
    pieces[piece.team][piece.type + piece.number]["hasMoved"] = true;
    console.log(pieces[piece.team][piece.type + piece.number]["hasMoved"]);
}
