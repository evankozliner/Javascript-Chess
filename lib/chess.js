...
(function() {
  ...
  grid.draw(whoseTurn).placePieces(pieces);
...
function handleDrop(e) {
  ...
  var figure = e.dataTransfer.getData('text/html'),
      previousLocation = document.getElementById(e.dataTransfer.getData('text/plain'));
  previousLocation.innerHTML = '';
  previousLocation.className = previousLocation.className.replace(/(?:^|\s)hasPiece(?!\S)/, '');
  this.innerHTML = figure.substring(figure.indexOf('<span'), figure.length);
