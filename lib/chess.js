...
function handleDrop(e) {
  ...
  // console.log(figureProperties.type.slice(figureProperties.type.length -1, figureProperties.type.length));
  // var piece = [
  //   figureProperties.team,
  //   figureProperties.type.slice(0, figureProperties.type.length - 1),
  //   figureProperties.type.slice(figureProperties.type.length -1, figureProperties.type.length)
  // ];
...
//TODO: write getHasMoved and setHasMoved
/**
 * Getter for hasMoved
 * @param {element} piece
